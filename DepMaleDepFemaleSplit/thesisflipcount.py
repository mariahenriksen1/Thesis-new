...
females = pd.read_csv(os.path.join(script_dir, "depressed_females.csv"))
males   = pd.read_csv(os.path.join(script_dir, "depressed_males.csv"))
...
plt.title("Flip Counts per 1000 Frames by AU (Depressed)")
