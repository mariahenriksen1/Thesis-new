...
# Get flip data
female_flips = compute_flips(depressed_females, au_columns)
male_flips = compute_flips(depressed_males, au_columns)
...
# Print results
print("Mann-Whitney U Test Results (Depressed Females vs Males)\n")
