...
nondep_females[selected_aus] = nondep_females[selected_aus].replace(-100, pd.NA)
nondep_males[selected_aus] = nondep_males[selected_aus].replace(-100, pd.NA)
...
print("Correlation Matrix for Non-Depressed Females:")
calculate_correlation_for_aus(nondep_females, 'Non-Depressed Females')

print("Correlation Matrix for Non-Depressed Males:")
calculate_correlation_for_aus(nondep_males, 'Non-Depressed Males')
