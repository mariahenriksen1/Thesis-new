...
female_auc = compute_auc(nondep_females)
male_auc = compute_auc(nondep_males)
...
plt.title("Box Plot of Normalized AUC Values by Action Unit (Non-Depressed Males vs Females)")
