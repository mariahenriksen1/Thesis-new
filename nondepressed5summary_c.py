...
female_flips = compute_flips_and_normalize(females, female_lengths, "Non-Depressed", "Female")
male_flips = compute_flips_and_normalize(males, male_lengths, "Non-Depressed", "Male")

# Combine both into one DataFrame
all_flips = pd.concat([female_flips, male_flips])

# Filter out just the Depressed data
depressed_flips = all_flips[all_flips['Group'] == "Non-Depressed"]
